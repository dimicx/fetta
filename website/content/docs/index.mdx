...
I built fetta because existing text-split libraries break kerning — the subtle spacing between characters that makes text look right. After splitting, characters shift and animations look off.

Fetta fixes this by preserving original character positions.
